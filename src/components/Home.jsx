    ...
    <main className="w-full min-h-dvh bg-black">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <video
          ...
          loop
          muted
          className="absolute inset-0 object-cover w-full h-full blur-md scale-103 z-0"
        />
        ...
        <div className="font-outfit font-extrabold text-[60px] sm:text-[64px] md:text-[96px] lg:text-[128px] text-white z-10 flex flex-col items-center justify-center leading-[0.8] px-2 sm:px-0 select-none -mt-20">
          ...
          <h1 className="bg-gradient-to-r from-lavender-400 via-lavender-200 to-lavender-400 bg-clip-text text-transparent backdrop-blur-[1px]">
            DESIGN
          </h1>
          <h1 className="bg-gradient-to-r from-transparent via-lavender-300 to-transparent bg-clip-text text-transparent backdrop-blur-[1px]">
            {'<DEVELOP/>'}
          </h1>
          <p className="text-lavender-100/80 tracking-widest z-10 text-base font-light mt-4 py-1 px-3 shadow-lg bg-white/10 backdrop-blur-[2px] rounded-4xl">
            “Turning creative ideas into beautiful digital experiences.”
          </p>
        </div>
      </section>
            ...
            <div className="flex flex-col items-center justify-center rounded-xl overflow-hidden z-10">
              ...
              <div className="absolute bottom-0 z-30 flex flex-col items-center justify-center w-full ">
                <AnimatedTitle
                  ...
                  containerClass="mt-2 text-lavender-100! font-light text-center text-7xl"
                />
